...
void Flow_EP_withEM(int flag_binning, int flag_sig, int flag_bkg, int flag_v2, int flag_run2,
    int flag_run2yield, std::string FileName = "AnalysisResultsMerged_OO.root",
    double mass_min = 2.3, double mass_max = 4.3, double cent_min = 0.,
    double cent_max = 20., double chi2max_mass = 2., double chi2max_v2 = 2.,
    double fmin = 1., double fmax = 5., bool sys = true, bool meanPt = false,
    bool SaveSys = true, std::string inputFlag = "goodmedium",
    std::string muonCut = "muonQualityCutsMUONStandalone", std::string dimuonCut = "") 
