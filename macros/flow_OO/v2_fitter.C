        ...
        for (int iTailSet = 0;iTailSet < nTailSets;iTailSet++) { // loop on tail parameters
          ...
          for (int iFitRange = 0;iFitRange < nFitRanges;iFitRange++) {
            ...
            if (varName == "Pt") {
              ...
              //fit_results_CB2_VWG__2.1_4.9_meanJpsi_widthJpsi__data_tails_histMassSEPM_0.0_2.0__0_20
              ...
              //profV2Name = Form("histU2Q2SEPM_%2.1f_%2.1f__%1.0f_%1.0f", minVarBin, maxVarBin, minFixVarBins[0], maxFixVarBins[0]);
            }
            if (varName == "Centr") {
